...
TFHT01 is a hygrometer and thermometer with an I2C interface for use on drones as an onboard weather station. Relative humidity and temperature are quantities that can affect both the flight characteristics of the drone and the execution of aerial works. At certain temperatures and relative humidity, icing can form on the lifting surfaces, worsening its flight characteristics or even causing a crash. Meteorological conditions can affect the payload as well - they can cause e.g. fogging on camera lenses, etc. It is therefore important to know about the presence of these phenomena during the flight.
...
#### TFHT01B (from 11/2024)
Introduced the use of membrane-covered sensors, and 3D printed sensor housing to enhance environmental protection.

#### TFHT01B (from 10/2023)
PCBs are covered by shrink tubing to increase protection. 

#### TFHT01B (from 05/2022)
PCB Thickness decreased to 0.8mm. 

#### TFHT01A (from 09/2021)
Bare PCB version with 1.6mm thickness
